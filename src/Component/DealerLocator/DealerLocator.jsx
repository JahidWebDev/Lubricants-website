...
<section className="bg-white min-h-screen flex items-center justify-center px-4">
  <div className="text-center max-w-md w-full">
    ...
    <div className="bg-red-50 text-red-600 px-4 py-3 rounded-md text-sm mb-6">
      Unable to display locations on map
    </div>

    {/* Button */}
    <button className="w-full bg-black text-white py-3 rounded-md font-medium hover:bg-gray-900 transition">
      Report Issue to Website admin
    </button>
