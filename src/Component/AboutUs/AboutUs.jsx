              ...
              >
                ...
                <div className="relative z-10 w-full h-full px-10 lg:px-20">
                  ...
                  <div className="absolute top-16 right-10 lg:right-20 max-w-xl">
                    ...
                    >
                      Since 2005, Zeetex has been delivering advanced tyres,
                      batteries, and lubricants across 146+ countries. With a
                      focus on safety, performance, and cutting-edge technology,
                      we aim to create meaningful impact for customers and
                      society worldwide.
                    </p>
                  </div>
            ...
            <div className="w-screen h-screen flex shrink-0">
              ...
              <div className="w-1/2 flex flex-col justify-between bg-white px-8 lg:px-20 pb-16">
                ...
                <div className="mt-20">
                  ...
                  >
                    Zeetex was established and introduced its first summer
                    tyres, beginning a global journey.
                  </p>
                </div>
              </div>
              ...
              <div className="w-1/2 relative h-full overflow-hidden">
                ...
                <div className="absolute bottom-16 left-0 px-12 text-white">
                  ...
                  >
                    Zeetex extends manufacturing to Indonesia to keep up with
                    the global demand.
                  </p>
                </div>
              </div>
            ...
            <div className="w-screen h-[800px] shrink-0 bg-white relative px-8 lg:px-20 py-16">
              ...
              <div className="max-w-[1800px]">
                ...
                <div className="mt-20">
                  ...
                  >
                    Zeetex launches the Max Range, proudly manufactured in
                    Thailand for global markets.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="w-screen h-screen relative shrink-0 overflow-hidden">
              ...
              <div className="relative z-10 w-full h-full flex justify-between">
                ...
                <div className="flex items-start px-12 pt-16 max-w-xl text-right">
                  ...
                  >
                    At Zeetex, every mile is a promise of progress, and every
                    innovation drives us closer to a smarter, safer future.
                    <br />
                    <br />
                    Join us as we continue shaping the road ahead - one
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center  max-w-3xl mx-auto mb-16">
            ...
            <p className="mt-6 font-avenir text-[18px] font-semibold leading-[30px] text-white">
              Zeetex tyres have displayed extra-ordinary performance in
              independent tests against top-tier brands at the IDIADA testing
              facility in Spain.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            ...
            <div>
              ...
              <img src={idiadalogo} alt="IDIADA Logo" className="w-56 mb-6" />
              <p className="max-w-md font-avenir text-[18px] font-semibold leading-[30px] text-white">
                IDIADA is an Official Technical Service for European
                Homologation offering comprehensive tyre testing for
                homologation, development, and characterization, including
                rolling resistance, wet grip, noise emissions, and dynamic
                performance.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-14">
            ...
            <div className="text-center">
              <div className="flex items-baseline justify-center gap-1 font-avenirlt text-[69px] leading-[69px] font-semibold">
                <span ref={(el) => (countRefs.current[0] = el)} data-end="145">
                  0
                </span>
                <span>+</span>
              </div>
